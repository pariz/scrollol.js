function Scrollol(navSelector, options) {
  ...
  var _callbackContainer = {
    clickedOnMenu: function(o) {
      ...
      return _storeOrResolveCallback.call(o, _callbacks, '_clickedOnMenu');

    },
    menuItemActive: function(o, state) {

      return _storeOrResolveCallback.call(o, _callbacks, '_menuItemActive', state);

    },
    menuItemInactive: function(o, state) {

      return _storeOrResolveCallback.call(o, _callbacks, '_menuItemInactive', state);

    },
    menuCollapsing: function(o) {

      return _storeOrResolveCallback.call(o, _callbacks, '_menuCollapsing');

    },
    menuExpanding: function(o) {

      return _storeOrResolveCallback.call(o, _callbacks, '_menuExpanding');

    },
    onScrolling: function(t, b, c, d) {

      return _storeOrResolveCallback.call(t, _callbacks, '_onScrolling', t, b, c, d);

    },
    onScrollingComplete: function(o) {

      return _storeOrResolveCallback.call(o, _callbacks, '_onScrollingComplete');
